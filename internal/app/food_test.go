...
func TestSaveFood_Execute(t *testing.T) {
	for idx, data := range []struct {
		...
		{ //05// change all values
			...
			food: core.Food{
				ID: 1, Category: 9, Flags: mock.Food1.Flags, KCal: 10, Fat: 11, FatSat: 12, FatO3: 13, FatO6: 14, Carbs: 15, Sugar: 16, Fructose: 2, Glucose: 3, Sucrose: 4, Protein: 17, Fiber: 18,
