...
function createComposer(options = {}) {
  ...
  const _fallbackLocale = ref(__root && _inheritLocale ? __root.fallbackLocale.value : isString$1(options.fallbackLocale) || isArray(options.fallbackLocale) || isPlainObject(options.fallbackLocale) || options.fallbackLocale === false ? options.fallbackLocale : _locale.value);
...
export { onUnmounted as A, createRouter as B, createWebHashHistory as C, DateTime as D, createApp as E, Fragment as F, createI18n as G, RouterLink as R, Settings as S, createBaseVNode as a, createVNode as b, createElementBlock as c, createTextVNode as d, unref as e, onMounted as f, createBlock as g, createCommentVNode as h, inject as i, renderList as j, RouterView as k, computed as l, renderSlot as m, normalizeClass as n, openBlock as o, watch as p, normalizeStyle as q, ref as r, withDirectives as s, toDisplayString$1 as t, useI18n as u, vModelText as v, withCtx as w, vModelSelect as x, createSlots as y, onBeforeMount as z };
